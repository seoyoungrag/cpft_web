...
insert into user (user_seq, created_at, modified_at, user_login_id, user_login_pw, user_nm,user_email, carrier_seq) values (null, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'ahreum.yu', '{bcrypt}$2a$10$C85WGE28Oij97u8ydXJjf./J5fsTy3z77HzKwea90IlI4Pmeuiaxu', '유아름', 'ahreum.yu@timf.co.kr',null);
