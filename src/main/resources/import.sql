...
insert into code values('1003',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'경력','5년 이상','Y','5년 이상');
insert into code values('1004',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'경력','10년 이상','Y','10년 이상');
insert into code values('1005',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'경력','경력없음','Y','경력없음');
...
insert into code values('1103',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'근무요일','월~금','Y','월~금');
insert into code values('1104',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'근무요일','월~토','Y','월~토');
...
insert into code values('1203',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'근무시간','새벽 파트','Y','새벽 파트');
insert into code values('1204',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'근무시간','오전~오후','Y','오전~오후');
insert into code values('1205',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'근무시간','오후~저녁','Y','오후~저녁');
insert into code values('1206',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'근무시간','저녁~새벽','Y','저녁~새벽');
